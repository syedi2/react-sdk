...
const ModalViewContainer = (props) => {
          ...
          Object.keys(currentItems[key].view).length > 0 ) {
            ...
            if (newComp && caseInfo && compareCaseInfoIsDifferent(caseInfo)) {
              ...
              if (newComp.getComponentName() === "reference") {
                ...
                arChildrenAsReact.push( createElement( createPConnectComponent(), {...configObject, key: `${caseName}-${ID}`}));
  ...
  return (
    ...
    aria-labelledby="form-dialog-title">
      <DialogTitle id="form-dialog-title" className={classes.dlgTitle}>{title}</DialogTitle>
